...
export const TODOS_CLI_MCP_PARITY: TodosCliMcpParityEntry[] = [
  ...
  },
  {
    ...
    cliCommands: [
      "todos reliability show",
      "todos reliability list",
      "todos reliability export",
    ],
    mcpTools: [
      "get_agent_reliability_scorecard",
      "export_agent_reliability_scorecards",
    ],
    jsonContracts: ["agent_reliability_scorecard", "agent_reliability_export", "structured_error", "api_error"],
    errorContracts: ["structured_error", "api_error"],
    status: "matched",
    intentionalGaps: [],
    example: {
  ...
  {
    domain: "local-snapshots",
    cliCommands: [
      "todos snapshots",
      "todos snapshots --show",
      "todos snapshots --poll",
    ],
    mcpTools: [
    ...
    jsonContracts: ["local_snapshot", "local_snapshot_poll_result", "structured_error", "api_error"],
    errorContracts: ["structured_error", "api_error"],
    status: "matched",
    example: {
      cli: "todos snapshots --show tasks --json",
      mcpTool: "get_local_snapshot",
    },
  },
  {
    domain: "imports",
