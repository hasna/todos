      ...
      schemas: {
        ...
        CreatePlanInput: {
          ...
          properties: {
            ...
            related_project_ids: { type: "array", items: { type: "string", minLength: 1 } },
            task_list_id: { type: "string", minLength: 1, nullable: true },
            agent_id: { type: "string", minLength: 1, nullable: true },
            status: { type: "string", enum: ["active", "completed", "archived"] },
          },
        },
        UpdatePlanInput: {
