...
beforeEach(async () => {
  ...
  server = await startServer(port, { open: false });
});
...
describe("GET /api/tasks", () => {
  ...
  it("should filter by status", async () => {
    ...
    const res = await fetch(url("/api/tasks?status=pending"));
    const data = await jsonBody(res);
  ...
  it("should filter by priority", async () => {
    ...
    const res = await fetch(url("/api/tasks?priority=critical"));
    const data = await jsonBody(res);
    expect(data).toHaveLength(1);
  ...
  it("should filter by project_id", async () => {
    ...
    const res = await fetch(url(`/api/tasks?project_id=${project.id}`));
    const data = await jsonBody(res);
    expect(data).toHaveLength(1);
...
describe("GET /api/tasks/:id", () => {
  ...
  it("should return 404 for non-existent task", async () => {
    const res = await fetch(url("/api/tasks/non-existent-id"));
...
describe("DELETE /api/tasks/:id", () => {
  it("should delete a task", async () => {
    ...
    const res = await fetch(url(`/api/tasks/${task.id}`), { method: "DELETE" });
    expect(res.status).toBe(200);
    const data = await jsonBody(res);
    expect(data.deleted).toBe(true);

    // Verify it's gone
    const getRes = await fetch(url(`/api/tasks/${task.id}`));
    expect(getRes.status).toBe(404);
  });

  it("should return 404 for non-existent task", async () => {
    const res = await fetch(url("/api/tasks/non-existent"), { method: "DELETE" });
    expect(res.status).toBe(404);
  });
});
...
describe("POST /api/tasks/:id/start", () => {
  it("should start a task", async () => {
    ...
    const res = await fetch(url(`/api/tasks/${task.id}/start`), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  it("should return 404 for non-existent task", async () => {
    const res = await fetch(url("/api/tasks/non-existent/start"), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  it("should return 409 when locked by another agent", async () => {
    ...
    // Start by agent-1
    await fetch(url(`/api/tasks/${task.id}/start`), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("POST /api/tasks/:id/complete", () => {
  it("should complete a task", async () => {
    ...
    const res = await fetch(url(`/api/tasks/${task.id}/complete`), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({}),
    });
  ...
  it("should return 404 for non-existent task", async () => {
    const res = await fetch(url("/api/tasks/non-existent/complete"), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({}),
    });
...
describe("GET /api/tasks/:id/comments", () => {
  it("should return empty array when no comments", async () => {
    ...
    const res = await fetch(url(`/api/tasks/${task.id}/comments`));
    expect(res.status).toBe(200);
    const data = await jsonBody(res);
    expect(data).toEqual([]);
  });
...
describe("GET /api/search", () => {
  it("should search tasks by title", async () => {
    ...
    const res = await fetch(url("/api/search?q=login"));
    expect(res.status).toBe(200);
    const data = await jsonBody(res);
    expect(data).toHaveLength(1);
  ...
  it("should search tasks by description", async () => {
    ...
    const res = await fetch(url("/api/search?q=searchterm"));
    const data = await jsonBody(res);
    expect(data).toHaveLength(1);
  ...
  it("should return empty for no matches", async () => {
    ...
    const res = await fetch(url("/api/search?q=zzzzzzz"));
    const data = await jsonBody(res);
    expect(data).toEqual([]);
  });
  ...
  it("should filter by project_id", async () => {
    ...
    const res = await fetch(url(`/api/search?q=bug&project_id=${project.id}`));
    const data = await jsonBody(res);
    expect(data).toHaveLength(1);
...
describe("Static file serving", () => {
  ...
  it("should return 404 for unknown POST routes", async () => {
    const res = await fetch(url("/api/nonexistent"), { method: "POST" });
    expect(res.status).toBe(404);
    const data = await jsonBody(res);
...
describe("Full task lifecycle", () => {
  it("should create, start, complete, and delete a task", async () => {
    ...
    // Start
    const startRes = await fetch(url(`/api/tasks/${created.id}/start`), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    // Complete
    const completeRes = await fetch(url(`/api/tasks/${created.id}/complete`), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ agent_id: "lifecycle-agent" }),
    });
    ...
    // Delete
    const deleteRes = await fetch(url(`/api/tasks/${created.id}`), {
      method: "DELETE",
    });
    expect(deleteRes.status).toBe(200);

    // Verify gone
    const getRes = await fetch(url(`/api/tasks/${created.id}`));
    expect(getRes.status).toBe(404);
  });
  ...
  it("should create task with project and add comment", async () => {
    ...
    // Add comment
    const commentRes = await fetch(url(`/api/tasks/${task.id}/comments`), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
