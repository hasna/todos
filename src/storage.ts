...
const _PostgresScopedSlugMigrationConflictErrorPublicWrapper = class PostgresScopedSlugMigrationConflictError extends Error {
  constructor(a0: any, ...args: any[]) { super(); assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, ...args]); const runtimeClass = loadRuntime().PostgresScopedSlugMigrationConflictError; bridgeRuntimeClassInstanceof(runtimeClass, PostgresScopedSlugMigrationConflictError); return publicizePublicSqliteBoundaryResult(Reflect.construct(runtimeClass, publicArgs, new.target)) as any; }
...
const _TodosShadowMirrorPublicWrapper = class TodosShadowMirror {
  constructor(a0: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, ...args]); const runtimeClass = loadRuntime().TodosShadowMirror; bridgeRuntimeClassInstanceof(runtimeClass, TodosShadowMirror); return publicizePublicSqliteBoundaryResult(Reflect.construct(runtimeClass, publicArgs, new.target)) as any; }
  ...
  getMetrics(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "getMetrics"), this, publicArgs)); }
  enqueueUpsert(a0: any, a1: any, a2: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, a1, a2, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "enqueueUpsert"), this, publicArgs)); }
  enqueueDelete(a0: any, a1: any, a2: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, a1, a2, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "enqueueDelete"), this, publicArgs)); }
  async flush(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "flush"), this, publicArgs)); }
  idle(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "idle"), this, publicArgs)); }
  notifyIdle(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "notifyIdle"), this, publicArgs)); }
  pump(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "pump"), this, publicArgs)); }
  async drain(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "drain"), this, publicArgs)); }
  async process(a0: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "process"), this, publicArgs)); }
  ensureSchema(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "ensureSchema"), this, publicArgs)); }
  async push(a0: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowMirror.prototype, "push"), this, publicArgs)); }
};
...
const _TodosShadowOutboxPublicWrapper = class TodosShadowOutbox {
  constructor(a0: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, ...args]); const runtimeClass = loadRuntime().TodosShadowOutbox; bridgeRuntimeClassInstanceof(runtimeClass, TodosShadowOutbox); return publicizePublicSqliteBoundaryResult(Reflect.construct(runtimeClass, publicArgs, new.target)) as any; }
  ...
  install(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "install"), this, publicArgs)); }
  getStats(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "getStats"), this, publicArgs)); }
  countByStatus(a0: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "countByStatus"), this, publicArgs)); }
  startLoop(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "startLoop"), this, publicArgs)); }
  stopLoop(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "stopLoop"), this, publicArgs)); }
  async flush(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "flush"), this, publicArgs)); }
  async drainOnce(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "drainOnce"), this, publicArgs)); }
  async processRow(a0: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "processRow"), this, publicArgs)); }
  async buildSnapshot(a0: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "buildSnapshot"), this, publicArgs)); }
  async readCurrent(a0: any, a1: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, a1, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "readCurrent"), this, publicArgs)); }
  tombstone(a0: any, a1: any, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([a0, a1, ...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "tombstone"), this, publicArgs)); }
  ensureSchema(...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(Reflect.get(loadRuntime().TodosShadowOutbox.prototype, "ensureSchema"), this, publicArgs)); }
};
...
export const closeRuntimeShadowCloud = async function closeRuntimeShadowCloud(this: unknown, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(loadRuntime().closeRuntimeShadowCloud, this, publicArgs)); } as unknown as typeof Runtime.closeRuntimeShadowCloud;
...
export const isTodosShadowEnabled = function isTodosShadowEnabled(this: unknown, ...args: any[]) { assertStageALocalStorageRole(process.env); const publicArgs = preparePublicSqliteBoundaryArguments([...args]); return publicizePublicSqliteBoundaryResult(Reflect.apply(loadRuntime().isTodosShadowEnabled, this, publicArgs)); } as unknown as typeof Runtime.isTodosShadowEnabled;
